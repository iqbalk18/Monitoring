...
@section('title', 'Final Billing Actions - Bali International Hospital')
...
@section('content')
    ...
    <div class="flex-between mb-4" style="flex-wrap: wrap; gap: 1rem;">
        <div>
            <h2 class="section-title">Final Billing Actions</h2>
    ...
    <div class="card-shadcn">
        <div class="card-shadcn-header flex-between">
            ...
            <a href="{{ route('billing2.export') }}?{{ http_build_query([
        'status' => $status,
        'type' => $typeFilter,
        'fromDate' => $fromDate,
        'toDate' => $toDate,
                ...
                <table class="table-shadcn" style="width: 100%;">
                    <thead>
                        <tr>
                            ...
                            <th style="min-width: 250px;">SAP Error Message</th>
                        ...
                        @forelse($recaps as $recap)
                            ...
                            @foreach($refs as $ref)
                                <tr>
                                    ...
                                    <td class="text-danger" style="font-size: 0.8125rem;">
                                        @if($recap['sapErrorMessage'])
                                            {{ $recap['sapErrorMessage'] }}
                                        @else
