        ...
        <form method="GET" action="{{ route('margin.index') }}">
            <div class="d-flex flex-wrap align-items-center" style="gap: 0.75rem;">
                <div class="flex-grow-1">
                    <input type="text" name="search" class="form-control-shadcn" placeholder="Search by Code, Description, Margin, ARCIM_ServMateria..." value="{{ request('search') }}" style="width: 100%;">
                </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center" style="gap: 0.375rem;">
                                <a href="{{ route('margin.edit', $margin->id) }}" class="btn-shadcn btn-shadcn-outline btn-shadcn-sm" title="Edit">
