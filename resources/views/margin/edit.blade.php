...
@section('content')
    ...
    <div class="flex-between mb-4" style="flex-wrap: wrap; gap: 1rem;">
        <div>
            <h2 class="section-title">Edit Margin Data</h2>
                    ...
                    <div class="col-md-6">
                        <div class="form-group-shadcn">
                            ...
                            <input type="text" id="TypeofItemCode" name="TypeofItemCode"
                                ...
                                placeholder="Enter TypeofItem Code" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group-shadcn">
                            ...
                            <input type="text" id="TypeofItemDesc" name="TypeofItemDesc"
                                ...
                                value="{{ old('TypeofItemDesc', $margin->TypeofItemDesc) }}" placeholder="Enter description"
                                required>
                        ...
                        <div class="form-group-shadcn">
                            ...
                            <div class="input-group-shadcn">
                                <input type="number" id="Margin" step="0.01" min="0" name="Margin"
                                    ...
                                    value="{{ old('Margin', $margin->Margin) }}" placeholder="0.00">
                            </div>
                            @error('Margin')
                                <div class="invalid-feedback-shadcn">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="col-md-6">
                        <div class="form-group-shadcn">
                            ...
                            <input type="date" id="DateFrom" name="DateFrom"
                                ...
                                value="{{ old('DateFrom', $margin->DateFrom ? $margin->DateFrom->format('Y-m-d') : '') }}"
                                required>
                            @error('DateFrom')
                                <div class="invalid-feedback-shadcn">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="col-md-6">
                        <div class="form-group-shadcn">
                            ...
                            <input type="date" id="DateTo" name="DateTo"
                                ...
                                value="{{ old('DateTo', $margin->DateTo ? $margin->DateTo->format('Y-m-d') : '') }}">
                            @error('DateTo')
                                <div class="invalid-feedback-shadcn">{{ $message }}</div>
                            @enderror
                        </div>
