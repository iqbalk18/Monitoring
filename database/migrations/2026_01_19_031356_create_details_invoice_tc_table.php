...
return new class extends Migration {
    ...
    {
        Schema::create('details_invoice_tc', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('SpecialistType')->nullable(); // Renamed from SpecialistTypeSurgery as per previous conv
            ...
            $table->text('ItemDescription')->nullable(); // Changed to text as desc can be long
    ...
    {
        Schema::dropIfExists('details_invoice_tc');
    }
};
