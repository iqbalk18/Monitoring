                        ...
                        @forelse($users as $index => $u)
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center" style="gap: 0.5rem;">
                                        <div
                                            style="width: 32px; height: 32px; border-radius: 50%; background: var(--muted); display: flex; align-items: center; justify-content: center;">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                stroke-linejoin="round" style="color: var(--muted-foreground);">
                                                <path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2" />
                                                <circle cx="12" cy="7" r="4" />
                                            </svg>
                                        </div>
                                ...
                                <td style="text-align: center;">
                                    <div class="d-flex align-items-center justify-content-center flex-wrap" style="gap: 0.375rem;">
                                        ...
                                        <form method="POST" action="{{ route('settings.deleteUser', $u->id) }}"
                                            class="d-inline-block delete-user-form">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
                                                class="btn-shadcn btn-shadcn-destructive btn-shadcn-sm btn-delete"
                                                title="Delete User">
                ...
                <form method="POST" action="{{ route('settings.addUser') }}">
                    ...
                    <div class="modal-body-shadcn">
                        <div class="mb-3">
                            ...
                            <input type="text" name="username" id="username" class="form-control-shadcn"
                                placeholder="Enter username" required>
                        </div>
                        <div class="mb-3">
                            <label for="password" class="form-label-shadcn">Password</label>
                            <input type="password" name="password" id="password" class="form-control-shadcn"
                ...
                <form id="changePasswordForm" method="POST" action="#">
                    ...
                    <div class="modal-body-shadcn">
                        <div class="mb-3">
                            ...
                            <input type="password" name="password" id="new_password" class="form-control-shadcn"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" name="password_confirmation" id="new_password_confirmation"
                                class="form-control-shadcn" placeholder="Confirm new password" required minlength="6">
                        </div>
                    </div>
                    <div class="modal-footer-shadcn">
                        <button type="button" class="btn-shadcn btn-shadcn-outline" data-bs-dismiss="modal">Cancel</button>
